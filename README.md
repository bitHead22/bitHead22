<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=32&duration=3000&pause=1000&color=2F81F7&center=true&vCenter=true&width=500&lines=Hey+I'm+Ayushman+Tiwari;Full-Stack+Developer" alt="Typing Animation" />
  ...
  <p>
    <a href="https://www.linkedin.com/in/ayushman-tiwari-a64b1028b/">
...
**🤖 AI/ML:** ![scikit-learn](https://img.shields.io/badge/scikit--learn-F7931E?style=flat-square&logo=scikit-learn&logoColor=white) ![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat-square&logo=pandas&logoColor=white)
...
### Mentora - AI-powered career advancement platform 
**Individual Project | [Live Demo](https://mentora-lake.vercel.app/) | [GitHub](https://github.com/bitHead22/Mentora)**
...
**Stack:** `Next.js` `JavaScript` `Tailwind` `Prisma` `NeonDB` `Clerk` `SHADCN/UI`
...
**Stack:** `React.js` `JavaScript` `Tailwind` `Supabase` `Clerk` `SHADCN/UI`
...
**🏅 Platforms:** LeetCode, Codeforces, TUF+ 
